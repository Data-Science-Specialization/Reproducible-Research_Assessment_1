...
```
The mean total number of steps taken per day is around `r round(dailyMeanNew, digits = 2)`, while the mean is `r round(dailyMedianNew, digits =2)`. Here is the histogram of the total number of steps taken per day:
